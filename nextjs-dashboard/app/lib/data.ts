...
// // Create a fetch of the sum of the invoices paid
// export async function fetchTotalPaidInvoices() {
//   try {
//     const data =
//       await sql`SELECT SUM(amount) FROM invoices WHERE status = 'paid'`;
//     return formatCurrency(data[0].sum ?? 0);
//   } catch (error) {
//     console.error("Database Error:", error);
...
//   try {
//     const data =
//       await sql`SELECT SUM(amount) FROM invoices WHERE status = 'pending'`;
//     return formatCurrency(data[0].sum ?? 0);
//   } catch (error) {
//     console.error("Database Error:", error);
